...
class ExerciseAdmin(admin.ModelAdmin):
    list_display = ('id', 'exercise_set', 'card', 'type', 'difficulty', 'order', 'is_active', 'created_at', 'updated_at')
    list_filter = ('type', 'difficulty', 'is_active', 'exercise_set', 'created_at', 'updated_at')
